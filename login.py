...
def show_login_page():
    ...
    st.markdown(
        ...
        <div class='auth-header'>
            ...
            <div>
                <div class='auth-title'>TalentScout AI</div>
    ...
    st.markdown(
        ...
        <div class='auth-footer'>
            © 2025 TalentScout AI - Smart Recruitment Assistant
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <div class='auth-header'>
            ...
            <div>
                ...
                <div class='auth-subtitle'>Join TalentScout AI Recruitment Platform</div>
            </div>
        </div>
        """,
        unsafe_allow_html=True,
