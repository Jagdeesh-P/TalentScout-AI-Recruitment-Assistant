...
MONGO_URI = "mongodb+srv://jagdeesh:<db_password>@talentscoutai.e2mx2.mongodb.net/?retryWrites=true&w=majority&appName=TalentScoutAI"# Update with actual MongoDB URI if needed
DB_NAME = "TalentScout"
